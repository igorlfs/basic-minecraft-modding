package biden.limao.networking;

import biden.limao.Limao;
import biden.limao.networking.packet.DrinkWaterC2SPacket;
import biden.limao.networking.packet.ExampleC2SPacket;
...
public class ModMessages {
    ...
    public static void register() {
        SimpleChannel net = NetworkRegistry.ChannelBuilder.named(new ResourceLocation(Limao.MOD_ID, "messages"))
