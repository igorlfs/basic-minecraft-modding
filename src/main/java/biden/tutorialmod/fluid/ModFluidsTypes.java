...
public class ModFluidsTypes {
    ...
    public static final ResourceLocation SOAP_OVERLAY_RL = new ResourceLocation(TutorialMod.MOD_ID,
            "misc/in_soap_water");

    public static final DeferredRegister<FluidType> FLUID_TYPES = DeferredRegister
            .create(ForgeRegistries.Keys.FLUID_TYPES, TutorialMod.MOD_ID);
